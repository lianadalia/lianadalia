...
I bring strong listening skills and a supportive approach to collaboration,
...
## 🎨 The primary tools & languages I use are Adobe, Figma, Mural, Marvel, HTML, and CSS. For Accessibility audits I follow WCAG: text accessibility, color contrast, image alt text, keyboard navigation, screen reader compatibility, NVDA, VoiceOver, TalkBack, and ARIA attributes. I use Claude Code to build Proof of Concepts and quick demos.
